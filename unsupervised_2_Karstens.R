...
## For deveaud2014 and Arun2010 the graph is decreasing at a decrasing rate, for Griffiths2004 it is incrasing at a decreasing rate, and CaoJuan2009 is pretty stable. 

#### Do you think that the number of topics is linear in the number of documents??
## I do not think the number of topics is linear. 
