...
# Changing the training set to .2 gives the set less features to run making it less precise
...
# The prior argument sets the unconditional probablility of observing once class to be the same as obsering any class. 
